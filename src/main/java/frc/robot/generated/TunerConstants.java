...
public class TunerConstants {
    ...
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(7);//"Need to double check this number 7"

    // Every 1 rotation of the azimuth results in kCoupleRatio drive motor turns;
    // This may need to be tuned to your individual robot

    //NEED TO CHANGE!!!!!!!!!!! please :(
    private static final double kCoupleRatio = 16;

    private static final double kDriveGearRatio = 16;
    private static final double kSteerGearRatio = 16;
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(-0.0029296875);
